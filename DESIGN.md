...
- Primary navigation: 项目总览、文档撰写、PPT 制作、联动工作台、概念与论证、参考文献、版本与交付
- Core routes/screens: `/writing`
- Content hierarchy: 文档项目 → 项目内正文/PPT/数据源 → 专用工作区或联动工作台 → 版本与交付
...
- Keyboard/focus behavior: 章节进展继续使用原生 `button`；目录细目继续使用 `details/summary`
...
- Offline/slow network, if applicable: 技术评价继续可用；模型不可用时保留已有报告并显示学术评价待运行
